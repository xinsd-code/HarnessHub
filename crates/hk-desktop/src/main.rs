...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::read_config_file_content,
            commands::write_config_file_content,
            commands::create_project_agent_rules_file,
            ...
            commands::create_agent_config_template,
            commands::import_agent_config_template,
            commands::update_agent_config_template_tag,
            commands::update_agent_config_template_content,
