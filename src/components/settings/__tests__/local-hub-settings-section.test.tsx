...
describe("LocalHubSettingsSection", () => {
  ...
  it("loads the current hub path and migrates assets when saving a new directory", async () => {
    ...
    mocks.api.getLocalHubSettings.mockResolvedValue({
      effective_path: "/Users/xinsd/.harnesskit",
      configured_path: null,
      default_path: "/Users/xinsd/.harnesskit",
      asset_count: 3,
      skills_count: 2,
      mcp_count: 1,
    });
    ...
    await waitFor(() =>
      expect(screen.getByDisplayValue("/Users/xinsd/.harnesskit")).toBeTruthy(),
    );
  ...
  it("can switch to a new empty directory without migrating assets", async () => {
    ...
    mocks.api.getLocalHubSettings.mockResolvedValue({
      effective_path: "/Users/xinsd/.harnesskit",
      configured_path: "/Users/xinsd/.harnesskit",
      default_path: "/Users/xinsd/.harnesskit",
      asset_count: 1,
      skills_count: 1,
      mcp_count: 0,
    ...
    fireEvent.change(screen.getByDisplayValue("/Users/xinsd/.harnesskit"), {
